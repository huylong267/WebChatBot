		...
		if(cart) {
			...
			jQuery.each(cart.items,function(i,item){
				...
				if(item.image != null)
					...
					tr.find('.item-image').html("<img src='//theme.hstatic.net/1000309753/1000610904/14/no_image.jpg?v=28'>");
...
function clone_item(product,i){
	...
	if ( product.image == null ) {
		item_product.find('img').attr('src','//theme.hstatic.net/1000309753/1000610904/14/no_image.jpg?v=28').attr('alt', product.url);
	} else {
...
$(document).on('lazyloaded', function(e){
	fixHeightProduct('.wrapper-collection-home  .content-product-list', '.product-resize', '.image-resize');
